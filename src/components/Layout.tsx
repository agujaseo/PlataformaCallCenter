...
import { LogOut, Menu, Settings, PhoneCall, Wrench, Building2, Layers } from 'lucide-react';
...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex overflow-hidden bg-gray-50">
      {/* Sidebar */}
      <div className={`
        fixed inset-y-0 left-0 z-50 w-[240px] bg-white shadow-lg transform 
      ...
      {/* Main content area */}
      <div className="flex-1 flex flex-col min-h-screen lg:pl-[50px]">
        {/* Header */}
